...
public class DeepslateWallBlock extends Block {
	...
	private boolean canConnectTo(IBlockAccess worldIn, BlockPos pos) {
		...
		return block != Blocks.BARRIER && (block == this || block instanceof BlockFenceGate || (material.isOpaque() && iblockstate.isFullCube() ? material != Material.GOURD : block instanceof DeepslateWallBlock || block instanceof BlockWall));
	}
